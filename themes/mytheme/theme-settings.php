...
function mytheme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['#submit'][] = 'mytheme_theme_settings_submit';
...
function mytheme_theme_settings_validate(&$form, &$form_state) {
  
}

function mytheme_theme_settings_submit(&$form, &$form_state) {
